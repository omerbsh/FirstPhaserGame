class Road extends Phaser.GameObjects.Container {
	...
	addObject()
	{
		var objs=[{key:"pcar1", speed:20,scale:10},{key:"pcar2", speed:30,scale:10},{key:"cone", speed:10,scale:5},{key:"barrier", speed:10,scale:20}];
		...
		Align.scaleToGameW(this.car, .10, scale);
	...
	moveObject()
	{
		...
		if(Collision.checkCollide(this.car,this.object)==true)
		{
			...
			this.scene.tweens.add({targets: this.car,duration: 1000,y: game.config.height,angle: -250});
